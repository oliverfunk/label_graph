...
fn main() {
    ...
    let n1 = LabelGraphNode::new(NodeData(2));
    let n2 = LabelGraphNode::new(NodeData(3));
    let n3 = LabelGraphNode::new(NodeData(4));
    ...
    g.link_nodes("n1", "n22", 2); // won't work

    println!();
    println!("n1's data before being modified: {:?}", g.get_node_data("n1"));
    {
        // modify n1's data
